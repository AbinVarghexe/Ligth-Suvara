...
import 'package:sundayschool_app/animator/animator_profile_screen.dart'; // Added
      ...
      builder: (context, userSnapshot) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            leadingWidth: 56, // Space for profile icon
              ...
              onTap: () {
                Navigator.of(context)
                    .push(
                      MaterialPageRoute(
                        builder: (context) =>
                            AnimatorProfileScreen(userData: userData),
                      ),
                    )
                    .then((_) => _loadUserProfile()); // Refresh if updated
              },
              child: Padding(
          ...
          body: _buildAssignmentsView(user),
        );
      },
    );
  }

  Widget _buildAssignmentsView(User user) {
    return StreamBuilder<DocumentSnapshot>(
      stream: _firestore
      ...
      builder: (context, snapshot) {
        ...
        if (assignments.isEmpty) {
          return _buildEmptyState('No assignments yet', 'Check back later');
        }
        ...
        return ListView(
          ...
          children: [
            ...
            ...assignments.asMap().entries.map((entry) {
              ...
              final String parish = assignmentMap['parish'] ?? 'Unknown Parish';
